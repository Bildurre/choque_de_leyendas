...
return [
    ...
    // Custom validation messages for application
    'total_attributes_limit' => 'El total de atributos debe estar entre :min y :max.',
    'unique_faction_name' => 'Este nombre de facción ya existe.',
    'unique_hero_name' => 'Este nombre de héroe ya existe.',
    'unique_card_name' => 'Este nombre de carta ya existe.',
    'valid_dice_notation' => 'El coste solo debe contener notación válida de dados (R, G, B).',
    'deck_min_cards' => 'El mazo debe contener al menos :min cartas.',
    'deck_max_cards' => 'El mazo no debe contener más de :max cartas.',
    'deck_required_heroes' => 'El mazo debe contener exactamente :number héroes.',
];