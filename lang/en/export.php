...
return [
  ...
  'confirm_delete_selected' => 'Are you sure you want to delete the selected exports?',
  'confirm_delete_all' => 'Are you sure you want to delete all exports?',
  'no_exports' => 'No exports available',
  'export_success' => 'Database exported successfully',
  'export_error' => 'Error exporting database',
  'deleted_selected_success' => ':count export(s) deleted successfully',
