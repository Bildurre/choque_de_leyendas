...
return [
  ...
  'include_data' => 'Include data (not just structure)',
  'compress_backup' => 'Compress to ZIP',
  'upload_backup' => 'Upload Backup',
  'upload_backup_help' => 'Upload an SQL or ZIP file containing an SQL file to restore the database.',
  ...
  'uploaded' => 'Uploaded',
  'restore' => 'Restore',
  'restore_confirm' => 'Are you sure you want to restore the database? This action will overwrite all current data.',
  ...
  'delete_all_confirm' => 'Are you sure you want to delete all backups?',
  'database_restore' => 'Restore Database',
  'upload_backup' => 'Upload Backup',
  'upload_backup_help' => 'Upload an SQL or ZIP file containing an SQL file to restore the database. Once uploaded, it will appear in the list of available backups.',
  'select_file' => 'Select file',
