<x-admin-layout>
  <div class="page-header">
    <h1 class="page-title">{{ __('deck_attributes.configurations') }}</h1>
  </div>
  
  <div class="page-content">
    <x-entity.list 
      :create-route="route('admin.deck-attributes-configurations.create')"
      :create-label="__('deck_attributes.create')"
      :items="$configurations"
      :emptyMessage="__('deck_attributes.no_configurations')"
    >
      @foreach($configurations as $configuration)
        <x-entity.list-card 
          ...
          :confirm-message="__('deck_attributes.confirm_delete')"
        >
          <div class="deck-attributes-details">
            <div class="deck-attributes-details__item">
              <span class="deck-attributes-details__label">{{ __('deck_attributes.min_cards') }}:</span>
              <span class="deck-attributes-details__value">{{ $configuration->min_cards }}</span>
            </div>
            
            <div class="deck-attributes-details__item">
              <span class="deck-attributes-details__label">{{ __('deck_attributes.max_cards') }}:</span>
              <span class="deck-attributes-details__value">{{ $configuration->max_cards }}</span>
            </div>
            
            <div class="deck-attributes-details__item">
              <span class="deck-attributes-details__label">{{ __('deck_attributes.max_copies_per_card') }}:</span>
