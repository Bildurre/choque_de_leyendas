<div class="ability-details">
  @if($entity->attackRange)
    <div class="ability-details__item">
      <span class="ability-details__label">{{ __('attack_ranges.singular') }}:</span>
  ...
  @if($entity->attackSubtype)
    <div class="ability-details__item">
      <span class="ability-details__label">{{ __('attack_subtypes.singular') }}:</span>
  ...
  @if($entity->area)
    <div class="ability-details__item">
      <span class="ability-details__label">{{ __('hero_abilities.type') }}:</span>
