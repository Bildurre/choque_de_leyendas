      ...
      <div class="form-section">
        ...
        <div class="form-group">
          ...
          <select 
            ...
            required
          >
            <option value="fighter" {{ old('superclass', $heroClass->superclass) == 'fighter' ? 'selected' : '' }}>Luchador</option>
            <option value="caster" {{ old('superclass', $heroClass->superclass) == 'caster' ? 'selected' : '' }}>Conjurador</option>
          </select>
          @error('superclass')
            <div class="invalid-feedback">{{ $message }}</div>
          @enderror
