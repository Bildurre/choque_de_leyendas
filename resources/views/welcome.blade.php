...
<x-public-layout>
  <div class="welcome-container">
    <div class="welcome-content">
      ...
      <p class="welcome-subtitle">{{ __('welcome.subtitle') }}</p>
    ...
    <div class="welcome-image">
      ...
      <div class="image-placeholder">
        ...
        <div class="placeholder-content">{{ __('welcome.game_art') }}</div>
      </div>
    </div>
  </div>
  ...
  <div class="welcome-sections">
    <section class="welcome-section">
      <h2 class="section-title">{{ __('welcome.section_title_1') }}</h2>
    ...
    <section class="welcome-section">
      <h2 class="section-title">{{ __('welcome.section_title_2') }}</h2>
      <div class="section-content">
        <div class="faction-grid">
          <div class="faction-card">
            <div class="faction-image">
              <div class="placeholder-content">{{ __('welcome.faction_image') }} 1</div>
            </div>
            <h3 class="faction-name">{{ __('welcome.faction_name') }} 1</h3>
          ...
          <div class="faction-card">
            <div class="faction-image">
              <div class="placeholder-content">{{ __('welcome.faction_image') }} 2</div>
            </div>
            <h3 class="faction-name">{{ __('welcome.faction_name') }} 2</h3>
          ...
          <div class="faction-card">
            <div class="faction-image">
              <div class="placeholder-content">{{ __('welcome.faction_image') }} 3</div>
            </div>
            <h3 class="faction-name">{{ __('welcome.faction_name') }} 3</h3>
    ...
    <section class="welcome-section">
      <h2 class="section-title">{{ __('welcome.section_title_3') }}</h2>
      <div class="section-content">
        ...
        <div class="feature-list">
          <div class="feature-item">
            <div class="feature-icon">
              <div class="placeholder-content">{{ __('welcome.feature_icon') }}</div>
            </div>
            <h3 class="feature-title">{{ __('welcome.feature_title_1') }}</h3>
          ...
          <div class="feature-item">
            ...
            <h3 class="feature-title">{{ __('welcome.feature_title_2') }}</h3>
          ...
          <div class="feature-item">
            ...
            <h3 class="feature-title">{{ __('welcome.feature_title_3') }}</h3>
          ...
          <div class="feature-item">
            ...
            <h3 class="feature-title">{{ __('welcome.feature_title_4') }}</h3>
    ...
    <section class="welcome-section">
      <h2 class="section-title">{{ __('welcome.section_title_4') }}</h2>
      <div class="section-content">
    ...
    <section class="welcome-section cta-section">
      <h2 class="section-title">{{ __('welcome.cta_title') }}</h2>
      <div class="section-content">
