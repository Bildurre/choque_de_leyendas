...
import initHeroAbilitySelector from './components/hero-ability-selector';
import initDeckCardSelector from './components/deck-card-selector';
import initDeckHeroSelector from './components/deck-hero-selector';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  initColorPicker();
  initFactionDeckForm();
  initHeroAbilitySelector();
  initDeckCardSelector();
  initDeckHeroSelector();
  initAdminFilters();
  initCostFilters();
  initCtaImageHeight();
  initTextImageHeight();
