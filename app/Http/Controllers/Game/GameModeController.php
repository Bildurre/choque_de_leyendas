...
class GameModeController extends Controller
{
  ...
  public function store(GameModeRequest $request)
  {
    ...
    try {
      ...
      return back()->with('error', __('common.errors.create', ['entity' => __('entities.game_modes.singular')]))
        ->withInput();
    }
  }
  ...
  public function update(GameModeRequest $request, GameMode $gameMode)
  {
    ...
    try {
      ...
      return back()->with('error', __('common.errors.update', ['entity' => __('entities.game_modes.singular')]))
        ->withInput();
    }
  }
  ...
  public function destroy(GameMode $gameMode)
  {
    try {
      ...
      return back()->with('error', __('common.errors.delete', ['entity' => __('entities.game_modes.singular')]));
    }
  }
  ...
  public function restore($id)
  {
    try {
      ...
      return back()->with('error', __('common.errors.restore', ['entity' => __('entities.game_modes.singular')]));
    }
  }
  ...
  public function forceDelete($id)
  {
    try {
      ...
      return back()->with('error', __('common.errors.force_delete', ['entity' => __('entities.game_modes.singular')]));
    }
  }
}